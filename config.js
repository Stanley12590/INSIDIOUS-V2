...
module.exports = {
    ...
    ownerNumber: [getConfig('OWNER_NUMBER', "255618558502")],
    version: "2.1.1",
    year: "2025",
    updated: "2026",
    ...
    // ============================================
    // DATABASE (FIXED - Use MONGODB_URI)
    // ============================================
    mongodbUri: getConfig('MONGODB_URI', getConfig('MONGODB_URL', "mongodb+srv://sila_md:sila0022@sila.67mxtd7.mongodb.net/insidious")),
